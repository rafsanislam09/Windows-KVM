...
export WINDOWS_DISK_CAPACITY=64G # Default maximum disk capacity is 64 Gigabyte. Change as your need. Remember, this value cannot be changed after installting Windows.
